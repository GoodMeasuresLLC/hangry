...
describe Hangry do
  ...
  context "standard food network recipe" do
    ...
    its(:image_url) { should == 'http://foodnetwork.sndimg.com/content/dam/images/food/unsized/2016/3/11/0/FN-TalentAvatar-Rachael-Ray-800x800.jpg.rend.sni2col.jpeg' }
    its(:ingredients) do
      should == [

...
require 'hangry/parsers/non_standard/food_com_parser'
...
require 'hangry/parsers/non_standard/diabetes_org_parser'
  ...
  class ParserClassSelecter
    ...
    def parser_class
      ...
      parser_classes = [
        ...
        Parsers::NonStandard::FoodComParser,
        ...
        Parsers::NonStandard::DiabetesOrgParser,
      ]
